...
This simulation model is suitable to play around with and test different settings. An extended version of this model was used to perform several experiments with multiple replications and analyse the results to compare the outcomes on statistical differences.
